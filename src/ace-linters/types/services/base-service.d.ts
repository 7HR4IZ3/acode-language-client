...
import { FilterDiagnosticsOptions, LanguageService, ServiceConfig, ServiceOptions, LanguageClientConfig } from "../types/language-service";
export declare abstract class BaseService<OptionsType extends ServiceOptions = ServiceOptions> implements LanguageService {
    ...
    serviceData: ServiceConfig | LanguageClientConfig;
